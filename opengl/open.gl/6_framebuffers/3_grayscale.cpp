...
// g++ -std=c++17 -Wextra -Wall -Werror -pedantic 3_grayscale.cpp -lglfw
// -lGLEW -lGL -lSOIL
...
const GLchar* screenFragmentSource = R"glsl(
    ...
    void main()
    {
        ...
        /*
        This works fine, but humans are the most sensitive to green and the least to blue,
        so a better conversion would work with weighed channels.
