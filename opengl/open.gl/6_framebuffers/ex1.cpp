...
// Try implementing the two-pass Gaussian blur effect by adding another
// framebuffer
...
int main() {
  ...
  // Create first framebuffer's Renderbuffer Object to hold depth and stencil
  // buffers
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    // Bind second framebuffer and draw contents of first framebuffer, blurring
    // horizontally
    glBindFramebuffer(GL_FRAMEBUFFER, frameBuffers[1]);
    glBindVertexArray(vaoQuad);
    ...
    // Bind default framebuffer and draw contents of second framebuffer,
    // blurring vertically
